...
public class SqliteDateTimeConverter implements AttributeConverter<OffsetDateTime, String> {
    ...
    @Override
    public String convertToDatabaseColumn(OffsetDateTime localDateTime) {
    ...
    public OffsetDateTime convertToEntityAttribute(String dbData) {
        ...
        try {
            return OffsetDateTime.parse(s, SQL_DATE_TIME);
        } catch (DateTimeParseException e) {
            // try with milliseconds
        }

        try {
            return OffsetDateTime.parse(s, SQL_DATE_TIME_MS);
        } catch (DateTimeParseException e) {
            // continue
        }
